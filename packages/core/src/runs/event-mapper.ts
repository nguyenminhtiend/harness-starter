import type { StreamEventPayload, TokenUsageDTO } from '../domain/session-event.ts';
...
export function mapStreamChunk(chunk: RuntimeStreamChunk): StreamEventPayload | undefined {
  ...
  switch (chunk.type) {
    ...
    default:
      return { type: 'artifact', name: chunk.type, data: p ?? { type: chunk.type } };
  }
}
